...
{AISNSW Mathematics Heads of Department Conference, October 2022}
...
\begin{frame}
  \frametitle{Exploring De Moivre's Theorem with DESMOS}
  \url{https://www.desmos.com/calculator/igqisujucx}
\end{frame}
...
\pause
$\sqrt{\cdot}: \mathbb{C} \rightarrow \mathbb{C}$ is single-valued and the input is restricted to the principal argument. However, the exponential is multi-valued.
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item<3->Stage 5: Extend the concept of exponentials continuously with index laws that fixes this problem.
...
\begin{frame}
  ...
  DESMOS Interactive: \url{https://www.desmos.com/calculator/deicpgcinp}\\
